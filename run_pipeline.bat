...
"C:\Program Files\R\R-4.4.3\bin\Rscript.exe" "C:\Users\Mark\Documents\label_denoising_record_linkage\src\r_programming\3_denoise_evaluation_scenarios.R" %dataset%

@REM DOWNSTREAM CLASSIFICATION PERFORMANCE
...
"C:\Program Files\R\R-4.4.3\bin\Rscript.exe" "C:\Users\Mark\Documents\label_denoising_record_linkage\src\r_programming\3_denoise_evaluation_scenarios_downstream_classifier.R" %dataset%
